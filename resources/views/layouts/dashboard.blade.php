        ...
        <div class="examiner-sidebar-inner flex flex-col h-full">
            ...
            <div class="examiner-sidebar-footer shrink-0 border-t border-slate-200 p-3 safe-area-b">
                <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <button type="submit" class="examiner-nav-link group flex w-full items-center gap-3 rounded-lg px-3 py-3 text-sm font-medium text-slate-700 hover:bg-rose-50 hover:text-rose-700 transition-all touch-manipulation" title="Log out">
