...
<div class="{{ $fabWrapClass }}" id="qs-support-fab-wrap">
    ...
    <div class="qs-support-fab" id="qs-support-fab">
        <div class="qs-support-menu" id="qs-support-menu" aria-hidden="true">
            <a href="{{ $supportWhatsAppUrl }}" class="qs-support-action qs-support-action--whatsapp" target="_blank" rel="noopener noreferrer" aria-label="Contact support on WhatsApp">
            ...
            <a href="tel:{{ $supportCallE164 }}" class="qs-support-action qs-support-action--call" aria-label="Call support">
                <span class="qs-support-action-icon" aria-hidden="true">
