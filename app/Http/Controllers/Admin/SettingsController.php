...
class SettingsController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.settings.index', [
            ...
            'ai_quiz_generation_enabled' => Setting::getValue(Setting::KEY_AI_QUIZ_GENERATION_ENABLED, '1') === '1',
            ...
            'student_password_login_enabled' => Setting::getValue(Setting::KEY_STUDENT_PASSWORD_LOGIN_ENABLED, '1') === '1',
            'student_otp_return_login_enabled' => Setting::getValue(Setting::KEY_STUDENT_OTP_RETURN_LOGIN_ENABLED, '0') === '1',
            'student_onboarding_email_otp_enabled' => Setting::getValue(Setting::KEY_STUDENT_ONBOARDING_EMAIL_OTP_ENABLED, '1') === '1',
            'student_email_required' => Setting::getValue(Setting::KEY_STUDENT_EMAIL_REQUIRED, '1') === '1',
            'student_password_reset_enabled' => Setting::getValue(Setting::KEY_STUDENT_PASSWORD_RESET_ENABLED, '1') === '1',
            'mail_configured' => MailConfigService::isConfigured(),
            'student_onboarding_email_otp_active' => StudentOnboardingEmailOtpService::isEnabled(),
            'student_password_reset_active' => Student::isPasswordResetEnabled(),
            'student_otp_max_attempts' => Setting::getValue(Setting::KEY_STUDENT_OTP_MAX_ATTEMPTS, '5'),
            'student_otp_lockout_minutes' => Setting::getValue(Setting::KEY_STUDENT_OTP_LOCKOUT_MINUTES, '15'),
            ...
            'student_dashboard_banner_enabled' => Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_ENABLED, '1') === '1',
            'student_dashboard_banner_mode' => Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_MODE, 'image'),
            'student_dashboard_banner_title' => Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_TITLE, 'Challenge Yourself.'),
            'student_dashboard_banner_title_accent' => Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_TITLE_ACCENT, 'Achieve More.'),
            'student_dashboard_banner_subtitle' => Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_SUBTITLE, 'Take quizzes, track progress and achieve your goals every day.'),
            'student_dashboard_banner_image' => ($imgs = json_decode(Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_IMAGES, '[]') ?: '[]', true)) && is_array($imgs) ? ($imgs[0] ?? '') : '',
            'student_dashboard_banner_images' => json_decode(Setting::getValue(Setting::KEY_STUDENT_DASHBOARD_BANNER_IMAGES, '[]') ?: '[]', true) ?: [],
