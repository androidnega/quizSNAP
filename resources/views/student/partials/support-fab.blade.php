...
<div class="{{ $fabWrapClass }}" id="qs-support-fab-wrap">
    ...
    <div class="qs-support-fab" id="qs-support-fab">
        <div class="qs-support-menu" id="qs-support-menu" aria-hidden="true" style="--fab-max: 1">
            <a href="{{ $supportWhatsAppUrl }}" class="qs-support-action qs-support-action--whatsapp" style="--fab-i: 0" target="_blank" rel="noopener noreferrer" aria-label="Contact support">
