...
(function () {
    ...
    function init() {
        ...
        if (startBtn) {
            ...
            // Flow is automatic after face verification; keep button hidden as fallback only.
            startBtn.classList.add('hidden');
        }

        // Auto-start quiz once face verification passes.
        document.addEventListener('quizsnap:face-verified', function () {
            startQuizSession();
        });
    ...
    window.QuizSnapCameraGate.startQuizSession = startQuizSession;
})();
