...
Route::middleware('admin.auth')->group(function () {
    ...
    // GET /dashboard is handled by DashboardGatewayController (unified)
        ...
        Route::post('/class-groups/{classGroupId}/students/{student}/reset-password', [ClassGroupController::class, 'resetStudentPassword'])->name('class-groups.students.reset-password');
