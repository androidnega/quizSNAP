        ...
        <div class="examiner-sidebar-inner flex flex-col h-full">
            ...
            <nav class="examiner-sidebar-nav flex-1 overflow-y-auto px-3 py-4 space-y-1">
                <ul class="space-y-1.5" role="list">
                    ...
                    <li><a href="{{ route('dashboard.students.index') }}" class="examiner-nav-link {{ request()->routeIs('dashboard.students.*') ? 'examiner-nav-link--active' : '' }} group flex items-center gap-3 rounded-lg py-3 px-3 text-sm font-medium min-w-0 transition-all" title="Search and manage students in your scope"><svg class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"/></svg><span class="examiner-nav-text truncate">Students</span></a></li>
                    ...
                    <li>
                        <a href="{{ route('dashboard.students.index') }}" class="examiner-nav-link {{ request()->routeIs('dashboard.students.*') ? 'examiner-nav-link--active' : '' }} group flex items-center gap-3 rounded-lg py-3 px-3 text-sm font-medium min-w-0 transition-all" title="Search and manage all students">
